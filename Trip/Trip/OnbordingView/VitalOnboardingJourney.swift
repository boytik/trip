// VitalOnboardingJourney.swift
// c13 — Smart Packing Companion
//
// Multi-step onboarding experience that introduces the app's core concepts:
// smart templates, conditions, dependency rules, and progress tracking.
// Each step has unique animations. English only.
