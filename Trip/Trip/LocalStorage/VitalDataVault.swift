// VitalDataVault.swift
// c13 — Smart Packing Companion
//
// JSON-file-based local persistence layer. No Core Data, no Realm.
// All data lives in the app's Documents directory as .json files.
...
/// The central nervous system of c13 data persistence.
