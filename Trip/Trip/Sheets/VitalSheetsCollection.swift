// VitalSheetsCollection.swift
// c13 — Smart Packing Companion
//
// All modal sheet implementations replacing VitalRouter placeholders.
// Sheets: CreateSession, AddItem, EditOrgan, SessionConditions,
// SessionReminders, ItemReason, ShareSession, RuleEditor.
// Keyboard-aware, dark-themed, animated.
