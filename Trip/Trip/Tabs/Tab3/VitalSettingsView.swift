// VitalSettingsView.swift
// c13 — Smart Packing Companion
//
// Tab 3 View — Settings, profile, gamification, statistics,
// notifications, data management. No theme picker.
// Three key actions:
//   1. Avatar & profile customization with gamification
//   2. Statistics dashboard & achievements
//   3. Data management (export, share, reset)
