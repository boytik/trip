// ConditionNexusView.swift
// c13 — Smart Packing Companion
//
// Tab 2 View — Conditions library with rule browsing,
// condition detail, rule editor, and sandbox.
// Three key actions:
//   1. Browse & search conditions with impact preview
//   2. Create / edit rules (if→then)
//   3. Test rules in sandbox mode
