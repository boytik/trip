// PackingPulseView.swift
// c13 — Smart Packing Companion
//
// Tab 1 View — displays active/archived packing sessions,
// gamification level bar, search, sort controls, and the
// create-session sheet. Three key actions on this screen:
//   1. Create new session
//   2. Open / manage existing sessions
//   3. View gamification progress + search/sort
