// PackingPulsePresenter.swift
// c13 — Smart Packing Companion
//
// VIPER Presenter for the Packing tab (Tab 1).
// Manages session list state, creation flow, filtering,
// countdown formatting, and gamification level display.
