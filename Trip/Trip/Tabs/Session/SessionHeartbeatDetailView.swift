// SessionHeartbeatDetailView.swift
// c13 — Smart Packing Companion
//
// Session Detail View (C2) — the command center for a packing session.
// Shows progress ring, countdown, filter pills, collapsible organ
// sections with checkable items, swipe actions, and bottom action bar.
// Replaces the placeholder SessionHeartbeatView.
